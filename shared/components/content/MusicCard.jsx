...
const MusicCard = ({
  ...
  const animatedWaveProgressStyle = useAnimatedStyle(() => ({
    width: waveWidth * displayedProgress.value,
  }));
        ...
        <View style={styles.controlContainer}>
          ...
          {isPlaying && (
            <View
              ...
              {...panHandlers}
            >
              <View style={styles.musicWaveContainer} pointerEvents="none">
                {waveWidth > 0 && (
                  <>
                    <MusicWave width={waveWidth} height={MUSIC_WAVE_HEIGHT} color={colors.fgNeutralWeak} />

                    <Animated.View style={[styles.musicWaveProgressClip, animatedWaveProgressStyle]}>
                      <MusicWaveTexture width={waveWidth} height={MUSIC_WAVE_HEIGHT} color={waveColor} />
                    </Animated.View>
                  </>
                )}
              </View>
